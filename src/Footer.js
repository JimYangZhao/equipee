            ...
            <div className='social__info'>
                <a href="tel:18337746320" className="jss58">
                    <div className="jss63 sc-bdVaJa iIlWNp">
                        <img alt="Black And White Vector Image Of Phone Ringing" src="https://res.cloudinary.com/dsfzcj5qk/image/upload/q_auto:eco/v1/Icons/Footer/phone-call.png" />
                    </div>
                ...
                <a href="mailto:contact@dozr.com" className="jss58">
                    <div class="jss63 sc-bdVaJa iIlWNp">
                        <img alt="Black And White Vector Image Of Email Letter" src="https://res.cloudinary.com/dsfzcj5qk/image/upload/q_auto:eco/v1/Icons/Footer/email.png" />
                    </div>
                    <div className="jss62 sc-bdVaJa iIlWNp">
